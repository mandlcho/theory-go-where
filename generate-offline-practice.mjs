...
<body data-view="home">
  ...
  <script>
    ...
    function renderExam() {
      ...
      $("#examTitle").textContent="Final Theory Paper "+state.paper; $("#examSub").textContent=review?"Answer review":"Choose the best answer, or press 1, 2, or 3. Your progress saves automatically.";
