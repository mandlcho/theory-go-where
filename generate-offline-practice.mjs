...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box} html{scroll-behavior:smooth}
    body{margin:0;background:var(--paper);color:var(--ink);font-family:ui-monospace,SFMono-Regular,Menlo,Monaco,Consolas,"Liberation Mono","Courier New",monospace;line-height:1.5}
    ...
    .ghost-light{border:1px solid rgba(255,255,255,.35);border-radius:9px;background:transparent;color:var(--on-accent);padding:9px 13px;font-weight:750}
...
<body data-view="home">
  <header class="topbar">
    <div class="topbar-inner">
      ...
      <div class="top-actions"><button id="cheatButton" class="ghost-light" type="button">Cheat sheet</button><button id="homeButton" class="ghost-light" type="button" hidden>Papers</button><button id="themeButton" class="ghost-light" type="button" aria-pressed="false">Night</button></div>
    </div>
  </header>
  <main>
    <section id="homeView">
  ...
  <script>
    ...
    function setTheme(theme,persist=true) {
      ...
      const button=$("#themeButton"); button.textContent=dark?"Light":"Night"; button.setAttribute("aria-pressed",String(dark)); button.setAttribute("aria-label",dark?"Switch to light mode":"Switch to night mode");
    ...
    function teachingFeedback(q,selected) {
      ...
      if(chosen?.correct) return '<aside class="teaching is-correct" role="status"><span class="teaching-label">Correct</span><p><strong>“'+esc(chosen.text)+'”</strong> is the right answer.</p></aside>';
      ...
      return '<aside class="teaching" role="status"><span class="teaching-label">Not quite — learn from this one</span><p>'+opening+'The correct answer is <strong>“'+esc(correct.text)+'”</strong> because '+teachingPrinciple(q)+'.'+contrast+'</p><a class="source-link" href="'+source.url+'" target="_blank" rel="noopener noreferrer">Official source: '+esc(source.title)+' ↗</a></aside>';
    }
